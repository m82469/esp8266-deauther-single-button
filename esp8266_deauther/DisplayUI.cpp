...
void DisplayUI::setupButtons() {
    ...
    // Single-button board (ANYX_ESP8266_V3_OLED): only DOWN is wired (GPIO0).
    // Holding it stands in for the A button — select/enter — instead of
    // repeat-scrolling, since there's no separate button left for that.
